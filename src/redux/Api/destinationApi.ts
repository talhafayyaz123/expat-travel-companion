...
export const { useDestinationAddMutation,useGetDestinationQuery,useGetSingleDesQuery,useUpdateDestMutation,useGetSingleUserDesQuery,useDeleteDestMutation } = userApi